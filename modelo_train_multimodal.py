...
try:
    ...
    print(f"Erro ao carregar base_tratada.csv: {e}")
    exit(1)
...
# ⚠️ Ajustar embeddings ao tamanho do df
...
# ========== 🔗 Combinar embeddings + categóricas ==========
...
for nome, modelo in models.items():
    ...
    if f1 > melhor_f1:
        ...
        print(f"\n✅ Modelo {nome} salvo com F1 = {f1:.4f}\n")

print(f"\n🏁 Melhor modelo: {melhor_modelo.__class__.__name__} (F1 = {melhor_f1:.4f})")
